...
ALTERNATIVE_ISSUE_NAME_KEYPATH = f"{ALTERNATIVE_ISSUE_KEY}.{NAME_KEY}"
COMMUNITY_RATING_AVERAGE_KEYPATH = f"{COMMUNITY_RATING_KEY}.{AVERAGE_RATING_KEY}"
COMMUNITY_RATING_COUNT_KEYPATH = f"{COMMUNITY_RATING_KEY}.{RATING_COUNT_KEY}"
