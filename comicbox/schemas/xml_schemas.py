...
class XmlRenderModule(BaseRenderModule):
    ...
    @override
    @classmethod
    def dumps(cls: "type[XmlRenderModule]", obj: dict, *args: None, **kwargs: None) -> str:
    ...
    @override
    @classmethod
    def loads(cls: "type[XmlRenderModule]", s: str | bytes | bytearray, *args: None, **kwargs: None) -> Any:
