...
def _publisher_to_cb(values: dict[str, dict[str, dict[str, str]]|str|None]) -> dict | None:
...
def _imprint_from_cb(values: dict[str, dict[str, str]|str], primary_id_source: str) -> dict | None:
...
def _publisher_from_cb(values: dict[str, dict[str, str]|str]) -> dict:
    metron_publisher = {}
...
def _imprint_to_cb(values: dict[str, dict[str, str]|str|None]) -> dict | None:
...
def _series_id_to_cb(values: dict[str, dict[str, str]|str]) -> None:
...
def _series_id_from_cb(values: dict[str, dict[str, int]|str]) -> None:
...
def _alternative_names_from_cb(comicbox_reprints: list[dict[str, dict[str, str]|str]]) -> list | None:
    alt_names = []
...
def _volume_to_cb(values: dict[str, int|str|None]) -> dict | None:
    volume = {}
