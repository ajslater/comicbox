...
def _create_role_variations_to_enum_map(role_aliases: MappingProxyType[Any, tuple]) -> dict:
...
def _credit_to_cb(metron_credit: dict[str, dict[str, list[Any]]|str], primary_id_source: str) -> tuple[str, dict]:
...
def _credits_to_cb(values: dict[str, list[dict[str, dict[str, list[dict[str, Any]]]|dict[str, list[Any]]|str]]]) -> dict:
...
def _role_from_cb(role_name: str, comicbox_role: dict[Any, Any], id_source: str, role_map: dict[str, set[Any]]) -> list:
...
def _credit_from_cb(
    person_name: str, comicbox_credit: dict, id_source: str, role_map: dict[str, set[Any]]
) -> dict:
...
def _credits_from_cb(values: dict[str, dict[str, dict[str, dict[str, dict[Any, Any]]]]|str], role_map: dict[str, set[Any]]) -> list:
...
def metron_credits_from_cb() -> MetaSpec:
    ...
    def from_cb(values: dict[str, dict[str, dict[str, dict[str, dict[Any, Any]]]]|str]) -> list[dict[str, dict[str, list[dict[str, Any]]|str]]]:
